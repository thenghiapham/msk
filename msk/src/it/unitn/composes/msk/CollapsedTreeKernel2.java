...
public class CollapsedTreeKernel2 implements KernelFunction<Tree>{

	private double lambda = 0.4;
//	private boolean lexicalized = true;
	protected VectorProvider semanticSpace;
	protected SentenceComposer composer;
	
	public CollapsedTreeKernel2(double lambda, VectorProvider semanticSpace, SentenceComposer composer) {
		this.composer = composer;
		this.lambda = lambda;
		this.semanticSpace = semanticSpace;
	}
	
	public CollapsedTreeKernel2() {
		semanticSpace = null;
		composer = null;
	}
...
//	}
	...
	public void setComposer(SentenceComposer composer) {
		this.composer = composer;
	}
	...
	public double value(Tree arg0, Tree arg1) {
		LexicalizedSemanticTree tree1 = composer.buildSemanticTree(LexicalizedTree.transform(arg0), semanticSpace);
		LexicalizedSemanticTree tree2 = composer.buildSemanticTree(LexicalizedTree.transform(arg1), semanticSpace);
//		System.out.println("*****************************");
